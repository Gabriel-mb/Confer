...
public class EpiCardController {
    ...
    public void setTableEmployee(String id) throws SQLException, IOException {
        ...
        epiList = FXCollections.observableList(epiDAO.episListBorrowed(Integer.valueOf(employeeId.getText())));
    ...
    public void onPrintButtonClick () throws JRException, SQLException, IOException {
        ...
        JRBeanCollectionDataSource itemsJRBean = new JRBeanCollectionDataSource(epiDAO.episListBorrowed(Integer.valueOf(employeeId.getText())));
